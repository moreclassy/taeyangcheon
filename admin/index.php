...
<title>태양천 갤러리 관리</title>
<link rel="stylesheet" href="admin.css?v=1">
</head>
<body data-mode="<?= h($mode) ?>" data-csrf="<?= h($csrf) ?>" data-categories='<?= h(json_encode($categories, JSON_UNESCAPED_UNICODE)) ?>'>

<header class="topbar">
  <div class="brand"><img src="../images/logo-m.png" alt=""><span>태양천 갤러리 관리</span></div>
  <?php if ($mode === 'admin'): ?>
  <nav>
...
<?php if ($mode === 'admin'): ?><script src="admin.js?v=1"></script><?php endif; ?>
</body>
</html>
